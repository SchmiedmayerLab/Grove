...
[`WeightScaleService`])../../SpeziBluetoothServices/BluetoothServices.docc/BluetoothServices.md) or
[`BloodPressureService`](../../SpeziBluetoothServices/BluetoothServices.docc/BluetoothServices.md)).
...
* Using the ``OmronManufacturerData/pairingMode-swift.property`` bit field of the ``OmronManufacturerData`` which is part of the advertisement data.
    Not all Omron devices include [`manufacturerData`](../../SpeziBluetooth/SpeziBluetooth.docc/SpeziBluetooth.md)
    in their advertisement. In this cases use the other approach.
* Deriving the pairing mode from the [`localName`](../../SpeziBluetooth/SpeziBluetooth.docc/SpeziBluetooth.md).
...
Most Omron devices expose a [`CurrentTimeService`](../../SpeziBluetoothServices/BluetoothServices.docc/BluetoothServices.md)
to support timestamps in reported measurements.
The device expects to receive updated time information when you receive the initial [`currentTime`](../../SpeziBluetoothServices/BluetoothServices.docc/BluetoothServices.md)
...
* A [`currentTime`](../../SpeziBluetoothServices/BluetoothServices.docc/BluetoothServices.md) notification was received
    (make sure you comply with <doc:#Time-Synchronization> requirements).
* A [`batteryLevel`](../../SpeziBluetoothServices/BluetoothServices.docc/BluetoothServices.md) notification was received.

- Tip: SpeziDevices improves pairing speed by not waiting for a disconnect to check these conditions, but notifying the [`PairedDevices`](../../SpeziDevices/SpeziDevices.docc/SpeziDevices.md)
