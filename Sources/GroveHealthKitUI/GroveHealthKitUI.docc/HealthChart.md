...
Typically, you probably will want to display only a single [`SampleType`](../../GroveHealthKit/GroveHealthKit.docc/SampleType.md) in a chart

### Example: Visualising Blood Oxygen Samples

Use the ``HealthKitQuery`` and ``HealthKitStatisticsQuery`` property wrappers to fetch Health data for a [`SampleType`](../../GroveHealthKit/GroveHealthKit.docc/SampleType.md) within your view.
