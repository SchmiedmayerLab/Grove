...
///
/// Queries are performed in the context of the [`HealthKit`](../../GroveHealthKit/GroveHealthKit.docc/GroveHealthKit.md) module, which must be enabled via an app's `GroveAppDelegate`.
///
