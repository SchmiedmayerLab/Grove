# ``GroveAccountPhoneNumbers``

A Grove framework that provides phone number management functionality for user accounts that can be used with `GroveAccount`.
...
`GroveAccountPhoneNumbers` provides phone number management functionality for the
[Grove](../../Grove/Grove.docc/Grove.md) framework ecosystem, enabling users to add, verify, and manage phone numbers in their accounts.

The framework integrates with the `GroveAccount` framework to provide a seamless phone number management experience.
...
- ``GroveAccount/AccountDetails/PhoneNumbersArray``
