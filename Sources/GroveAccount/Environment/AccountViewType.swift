...
/// Defines the type of `GroveAccount` view a ``DataEntryView`` or ``DataDisplayView`` is placed in.
///
...
extension EnvironmentValues {
    /// The type of `GroveAccount` view a ``DataEntryView`` or ``DataDisplayView`` is placed in.
    ///
    /// ## Topics
    /// - ``AccountViewType``
