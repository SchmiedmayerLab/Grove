...
/// Error thrown by the GroveHealthKitFHIR module if transforming a specific `HKSample` type to an FHIR resource was not possible.
@available(iOS 18, macOS 15, watchOS 11, *)
public enum GroveHealthKitFHIRError: Error {
    /// Indicates that a specific `HKSample` type is currently not supported by GroveHealthKitFHIIR.
    case notSupported
