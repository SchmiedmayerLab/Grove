...
Send ``HealthKitFHIRConversion/bundle``. The other properties are there for inspection and testing.
...
The **application device** is your app — the software that read the sample out of HealthKit and converted it. Its identity comes from ``HealthKitFHIRApplication``.
