...
struct ChoiceRow<AccessoryIfSelected: View>: View {
    ...
    var body: some View {
        Button {
            ...
            // Timed by the direction the row is moving: the one being confirmed is worth watching arrive,
            // the one being cleared is not.
            .animation(isSelected ? SelectionFeedback.confirmation : SelectionFeedback.deselection, value: isSelected)
        }
