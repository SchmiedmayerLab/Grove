...
///
/// - Important: The `FirestoreAccountStorage` uses the [`accountId`](../GroveAccount/GroveAccount.docc/GroveAccount.md)
...
/// ```
///
/// - Important: In order to use the `FirestoreAccountStorage`, you must have [`Firestore`](../GroveFirestore/GroveFirestore.docc/GroveFirestore.md)
...
public actor FirestoreAccountStorage: AccountStorageProvider {
    ...
    ///   [`Firestore`](../GroveFirestore/GroveFirestore.docc/GroveFirestore.md)
    ...
    ///
    /// By default, the [`identifier`](../GroveAccount/GroveAccount.docc/GroveAccount.md)
    ...
    ///     or provide backwards compatibility with details stored with GroveAccount 1.0.
    ...
    @_documentation(visibility: internal)
    public func store(_ accountId: String, _ modifications: GroveAccount.AccountModifications) async throws {
        let document = userDocument(for: accountId)
