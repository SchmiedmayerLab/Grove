...
### 1. Add Grove Speech as a Dependency

You need to add the GroveSpeech Swift package to
...
### 2. Configure the `SpeechSynthesizer` in the Grove `Configuration`
...
The code example demonstrates the usage of the Grove ``SpeechSynthesizer`` within a minimal SwiftUI application.
...
GroveSpeech also supports selecting voices, including [personal voices](https://support.apple.com/en-us/104993).
