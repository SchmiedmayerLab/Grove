...
public protocol QuestionKindDefinitionWithFHIRDecodingSupport: QuestionKindDefinition {
    ...
    static func parse(_ item: ModelsR4.QuestionnaireItem) throws(GroveQuestionnaire.Questionnaire.FHIRConversionError) -> Config?
}


/// A question kind that can turn its `GroveQuestionnaire` responses into FHIR R4 `QuestionnaireResponseItemAnswer`s.
@available(iOS 18, macOS 15, watchOS 11, *)
