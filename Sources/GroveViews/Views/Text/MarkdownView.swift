...
///
/// You use this view to display [`MarkdownDocument`](../../../GroveFoundation/GroveFoundation.docc/GroveFoundation.md).
///
...
public struct MarkdownView<CustomElementView: View>: View {
    ...
    ///
    /// When rendering a [`MarkdownDocument`](../../../GroveFoundation/GroveFoundation.docc/GroveFoundation.md),
    /// the ``MarkdownView`` internally turns each of the `MarkdownDocument`'s [`Block`](../../../GroveFoundation/GroveFoundation.docc/GroveFoundation.md)s into a separate SwiftUI `View`.
    ///
    ...
    ///
    /// - parameter document: The [`MarkdownDocument`](../../../GroveFoundation/GroveFoundation.docc/GroveFoundation.md) the view should display
...
extension MarkdownView {
    /// Creates a new MarkdownView
    ///
    /// - parameter markdownDocument: The [`MarkdownDocument`](../../../GroveFoundation/GroveFoundation.docc/GroveFoundation.md) the view should display
    /// - parameter dividerRule: Defines when the view should place a `Divider` between two sections. Defaults to ``DividerRule/never``.
    /// - parameter customElementViewProvider: A `ViewBuilder` closure that provides backing views for custom elements in the Markdown which cannot be handled by the ``MarkdownView`` itself.
