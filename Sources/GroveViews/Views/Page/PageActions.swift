...
/// A page's primary action, with an optional secondary one below it.
///
/// Placed in a ``PageView``'s footer, the buttons float over the content, which fades out beneath them as it scrolls.
///
/// ```swift
...
@available(iOS 18, macOS 15, watchOS 11, *)
extension PageActions {
    /// Creates a primary button.
    /// - Parameters:
    ///   - viewState: An optional `ViewState` binding.
    ///   - title: The title of the primary button.
    ...
    /// Creates a primary button and a secondary button.
    /// - Parameters:
