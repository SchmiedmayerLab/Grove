...
///
/// > Important: You will need to register the ``AccessGuard`` module in your Spezi using the [`configuration`](../Spezi/Spezi.docc/Spezi.md)
/// in a [`SpeziAppDelegate`](../Spezi/Spezi.docc/Spezi.md) as detailed in the ``AccessGuard`` documentation.
///
/// ```swift
