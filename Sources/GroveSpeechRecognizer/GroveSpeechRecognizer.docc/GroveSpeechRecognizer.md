...
### 2. Configure the `SpeechRecognizer` in the Grove `Configuration`
...
The code example demonstrates the usage of the Grove ``SpeechRecognizer`` within a minimal SwiftUI application.
