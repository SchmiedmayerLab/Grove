...
public struct CharacteristicDescription {
    ...
    /// Flag indicating if GroveBluetooth should automatically read the initial value from the peripheral.
    ...
    ///   - autoRead: Flag indicating if GroveBluetooth should automatically read the initial value from the peripheral.
