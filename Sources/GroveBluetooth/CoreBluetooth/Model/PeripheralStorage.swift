...
final class PeripheralStorage: ValueObservable, Sendable {
    ...
    @GroveBluetooth var services: [BTUUID: GATTService]? { // swiftlint:disable:this discouraged_optional_collection
        didSet {
    ...
    @GroveBluetooth var peripheralName: String? {
        get {
            access(keyPath: \._peripheralName)
    ...
    @GroveBluetooth var advertisementData: AdvertisementData {
        get {
    ...
    @GroveBluetooth var state: PeripheralState {
        get {
            readOnlyState
        }
        set {
    ...
    @GroveBluetooth var nearby: Bool {
        get {
            readOnlyNearby
        }
        set {
