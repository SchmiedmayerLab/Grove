...
///
/// - Important: This closure is called from the ``GroveBluetooth/GroveBluetooth`` global actor, if you don't pass in an async method
...
public struct Characteristic<Value: Sendable>: Sendable {
    ...
    final class State: Sendable {
        ...
        @GroveBluetooth var value: Value? {
            get {
                readOnlyValue
            }
            set {
    ...
    ///     the view on the characteristic might have changed due to the asynchronous nature of GroveBluetooth.
