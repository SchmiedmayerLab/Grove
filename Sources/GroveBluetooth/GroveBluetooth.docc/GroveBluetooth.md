...
The Grove Bluetooth module provides a convenient way to handle state management with a Bluetooth device,
...
> Tip: You will need a basic understanding of the Bluetooth Terminology and the underlying software model to understand
    the structure and API of the Grove Bluetooth module. You can find a good overview in the
...
### Add Grove Bluetooth as a Dependency

You need to add the Grove Bluetooth Swift package to
...
The ``Bluetooth`` module needs to be registered in a Grove-based application using the
[`configuration`](../../Grove/Grove.docc/Grove.md) in a
