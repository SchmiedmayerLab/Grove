...
- Convert a [FHIR R4 Questionnaire](https://hl7.org/fhir/R4/questionnaire.html) into a Spezi [`Questionnaire`](../../SpeziQuestionnaire/SpeziQuestionnaire.docc/SpeziQuestionnaire.md)
    - support for partially and fully custom question kinds using `item-control` and FHIR extensions
- Convert a Spezi [`QuestionnaireResponses`](../../SpeziQuestionnaire/SpeziQuestionnaire.docc/SpeziQuestionnaire.md) instance into a [FHIR R4 QuestionnaireResponse](https://hl7.org/fhir/R4/questionnaireresponse.html)
