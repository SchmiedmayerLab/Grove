...
///
/// `ConsentDocument`s are created from Markdown-formatted text, which can optionally include custom interactive elements defined by GroveConsent,
...
/// ---
/// ```
/// The following keys are defined by GroveConsent:
