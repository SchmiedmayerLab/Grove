...
public final class GroveLocation: Module, DefaultInitializable, EnvironmentAccessible {
    ...
    /// Initializes a new instance of `GroveLocation`. It sets up the location manager and its delegate.
    public init() {
