...
///
/// This view retrieves the pending measurements from the [`HealthMeasurements`](../../GroveDevices/GroveDevices.docc/GroveDevices.md)
/// Module that is present in the SwiftUI environment.
@available(iOS 18, macOS 15, watchOS 11, *)
public struct MeasurementsRecordedSheet: View {
    private let logger = Logger(subsystem: "org.grovealliance.devices", category: "MeasurementsRecordedSheet")
