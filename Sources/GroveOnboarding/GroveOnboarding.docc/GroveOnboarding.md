...
@Row {
    ...
    @Column {
        @Image(source: "Consent", alt: "Screenshot displaying the consent view.") {
            In combination with the Grove Consent Module [`OnboardingConsentView`](../../GroveConsent/GroveConsent.docc/GroveConsent.md), to allow users to read, sign, and export consent documents.
        }
    }
}
