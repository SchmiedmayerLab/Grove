...
- Tip: The ``ChatView`` provides speech-to-text (recognition) as well as text-to-speech (synthesize) accessibility capabilities out-of-the-box via the [`SpeziSpeech`](../../SpeziSpeech/README.md) module, facilitating seamless interaction with the content of the ``ChatView``.
