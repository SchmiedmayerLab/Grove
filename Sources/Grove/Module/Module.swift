...
/// A `Module` defines a software subsystem that can be configured as part of the ``GroveAppDelegate/configuration``.
public protocol Module: AnyObject, SendableMetatype {
    /// Called on the initialization of the Grove instance to perform a lightweight configuration of the module.
    ///
