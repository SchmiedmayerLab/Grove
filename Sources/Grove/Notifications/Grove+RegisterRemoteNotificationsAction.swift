...
@available(*, deprecated, renamed: "Grove.RegisterRemoteNotificationsAction", message: "Please use Grove.RegisterRemoteNotificationsAction instead.")
public typealias RegisterRemoteNotificationsAction = Grove.RegisterRemoteNotificationsAction
    ...
    public struct RegisterRemoteNotificationsAction: Sendable {
        ...
        public func callAsFunction() async throws -> Data {
            guard let grove else {
                preconditionFailure("\(Self.self) was used in a scope where Grove was not available anymore!")
            }
