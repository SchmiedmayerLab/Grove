...
@available(iOS 18, macOS 15, watchOS 11, *)
extension _ModifierPropertyWrapper: GrovePropertyWrapper {
    func clear() {
        collected = false
        grove?.handleViewModifierRemoval(for: id)
    }
...
extension Module {
    ...
    ///
    /// - Note: The contents of the `@Modifier` property wrapper are collected after the ``Module/configure()`` call returns.
