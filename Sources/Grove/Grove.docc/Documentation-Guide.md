...
Defines the documentation requirements for Grove modules, including hints and examples on structuring the documentation your Grove module, Swift Package, and repository.

The keywords "MUST", "MUST NOT", "REQUIRED", "SHALL", "SHALL NOT", "SHOULD", "SHOULD NOT", "RECOMMENDED", "MAY", and "OPTIONAL" in this document are to be interpreted as described in [RFC 2119](https://www.ietf.org/rfc/rfc2119.txt).

> Tip: This guide uses the terminology defined in the <doc:Grove-Guide>.
...
All public interfaces of a Grove module MUST be documented with non-trivial documentation that SHOULD guide a wide variety of users on how to use the application programming interface (API).

Text MUST be written in a neutral form in conformance to the <doc:Contributing-Guide> and the [Contributor Covenant Code of Conduct](https://github.com/SchmiedmayerLab/.github/blob/main/CODE_OF_CONDUCT.md).
Abbreviations SHOULD be expanded the first time they are used.
Inline documentation SHOULD have real-world examples and links to relevant information outside of the Grove ecosystem to read up on important concepts.
...
It is RECOMMENDED to use `@_documentation(visibility: internal)` to an `@_exported import` statement to ensure that all public symbols of the imported module are not exposed in the documentation of the Grove module.
...
```md
![Example Image](Resources/Example.png#gh-light-mode-only)
![Example Image](Resources/Example~dark.png#gh-dark-mode-only)
```
...
It MUST link to the main types relevant to the Grove module and SHOULD provide some guidance to articles that guide the user to learn more about the module.
...
The README of a Grove Module is an essential first point of contact.
...
The README SHOULD reuse the content of the landing page DocC documentation of the Grove module. It MAY add context relevant to the GitHub repository compared to the automatically generated documentation.


### Header

The Header MUST display the most essential documentation for a Grove Module, including:
...
- Badges for Swift package-based Grove modules to indicate the supported Swift version and operating systems, if those badges are generated by the current documentation hosting setup.
...
DocC links MUST be translated into links to the local DocC documentation or the configured hosted documentation using markdown links.


### Example

The example section MUST include one or more code examples or short guidance on using the Grove Module.
...
The example MUST provide a link to more information in the local DocC documentation or the configured hosted documentation.

E.g., a final sentence MAY look like this:
```md
For more information, please refer to the [API documentation](Grove.md).
```

### Footer

The footer of all Grove modules MUST include a link to the contributing guidelines, code of conduct, and license information.
Grove modules in this monorepo SHOULD use the footer pattern below.
Other Grove modules MAY use the same footer but MUST adjust it to link to their documents, e.g., contributing guidelines.
```md
## Contributing
...
GitHub repository SHOULD include the main description of the Grove module and SHOULD link to the configured hosted documentation in the sidebar of the GitHub repository.
GitHub tags like `Grove` and others MAY be used to easily find the module on GitHub and other configured package catalogs.
