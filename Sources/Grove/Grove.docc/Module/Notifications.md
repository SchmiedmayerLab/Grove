...
Grove provides platform-agnostic mechanisms to manage and respond to User Notifications within your ``Module`` or ``Standard``.
...
To register for remote notifications, you can use the ``Module/Application`` property and the corresponding ``Grove/registerRemoteNotifications`` action.
...
Refer to the ``Grove/unregisterRemoteNotifications`` action on how to unregister from remote notifications. 
...
- ``Grove/registerRemoteNotifications``
- ``Grove/unregisterRemoteNotifications``
