...
public enum LocalizedFileResolution {
    private static let logger = Logger(subsystem: "org.grovealliance", category: "GroveLocalization")
}
...
extension LocalizedFileResolution {
    ...
    ///
    /// - parameter url: The `URL` of a localized file (e.g., `/Users/grove/Documents/Welcome+en-US.md`).
    /// - returns: If `URL` contains localization info compatible with GroveLocalization: the `URL`, with its localization into stripped, and the extracted localization info; otherwise `nil`.
