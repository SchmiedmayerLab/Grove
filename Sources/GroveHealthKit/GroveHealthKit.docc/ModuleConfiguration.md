...
Configure Grove's HealthKit module to work with your app
...
The `HealthKit` module manages this for Grove applications: the module builds up the set of Health data access requirements of all configuration components, and keep track of the app's current Health data access requirements. 
