...
extension LLMToolParameterItemSchema {
    public struct Property: Sendable {
        ...
        /// Initializes a `LLMToolParameterItemSchema/Property`.
        ///
        /// - Parameters:
        ///   - name: The name of the parameter.
        ///   - type: The type of the parameter, see `LLMToolParameterItemSchema/Property/PropertyType`.
    ...
    /// Initialize a simple, one-level, object-based ``LLMToolParameterItemSchema``.
    /// - Parameter objectProperties: The `LLMToolParameterItemSchema/Property`s of the schema.
