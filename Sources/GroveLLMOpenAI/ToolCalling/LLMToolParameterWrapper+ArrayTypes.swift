...
extension _LLMToolParameterWrapper where T: AnyArray, T.Element: BinaryInteger {
    /// Declares an `Int`-based ``LLMTool/Parameter`` `array`.
    ///
    /// - Parameters:
...
@available(iOS 18, macOS 15, watchOS 11, *)
extension _LLMToolParameterWrapper where T: AnyArray, T.Element: BinaryFloatingPoint {
    /// Declares an `Float` or `Double` (`BinaryFloatingPoint`) -based ``LLMTool/Parameter`` `array`.
    ///
    /// - Parameters:
    ///    - description: Describes the purpose of the parameter, used by the LLM to grasp the purpose of the parameter.
    ///    - const: Specifies the constant `String`-based value of a certain parameter.
...
@available(iOS 18, macOS 15, watchOS 11, *)
extension _LLMToolParameterWrapper where T: AnyArray, T.Element == Bool {
    /// Declares an `Bool`-based ``LLMTool/Parameter`` `array`.
    ///
    /// - Parameters:
    ///    - description: Describes the purpose of the parameter, used by the LLM to grasp the purpose of the parameter.
    ///    - const: Specifies the constant `String`-based value of a certain parameter.
...
@available(iOS 18, macOS 15, watchOS 11, *)
extension _LLMToolParameterWrapper where T: AnyArray, T.Element: StringProtocol {
    /// Declares an `String`-based ``LLMTool/Parameter`` `array`.
    ///
    /// - Parameters:
    ///    - description: Describes the purpose of the parameter, used by the LLM to grasp the purpose of the parameter.
