...
extension _LLMToolParameterWrapper where T: AnyOptional, T.Wrapped: BinaryInteger {
    /// Declares an ``LLMTool/Parameter`` of the type `Int?` defining a integer parameter of the ``LLMTool``.
    ///
    /// - Parameters:
...
@available(iOS 18, macOS 15, watchOS 11, *)
extension _LLMToolParameterWrapper where T: AnyOptional, T.Wrapped: BinaryFloatingPoint {
    /// Declares an ``LLMTool/Parameter`` of the type `Float?` or `Double?` (`FloatingPoint?`)  defining a floating-point parameter of the ``LLMTool``.
    ///
    /// - Parameters:
    ///    - description: Describes the purpose of the parameter, used by the LLM to grasp the purpose of the parameter.
    ///    - const: Specifies the constant `String`-based value of a certain parameter.
...
@available(iOS 18, macOS 15, watchOS 11, *)
extension _LLMToolParameterWrapper where T: AnyOptional, T.Wrapped == Bool {
    /// Declares an ``LLMTool/Parameter`` of the type `Bool?` defining a binary parameter of the ``LLMTool``.
    ///
    /// - Parameters:
    ///    - description: Describes the purpose of the parameter, used by the LLM to grasp the purpose of the parameter.
    ///    - const: Specifies the constant `String`-based value of a certain parameter.
...
@available(iOS 18, macOS 15, watchOS 11, *)
extension _LLMToolParameterWrapper where T: AnyOptional, T.Wrapped: StringProtocol {
    /// Declares an ``LLMTool/Parameter`` of the type `String?` defining a text-based parameter of the ``LLMTool``.
    ///
    /// - Parameters:
    ///    - description: Describes the purpose of the parameter, used by the LLM to grasp the purpose of the parameter.
    ...
    public convenience init(
        description: some StringProtocol,
        format: _LLMToolParameterWrapper.Format? = nil,
...
@available(iOS 18, macOS 15, watchOS 11, *)
extension _LLMToolParameterWrapper where T: AnyOptional, T.Wrapped: AnyArray,
    T.Wrapped.Element: BinaryInteger {
    /// Declares an optional `Int`-based ``LLMTool/Parameter`` `array`.
    ///
    /// - Parameters:
    ///    - description: Describes the purpose of the parameter, used by the LLM to grasp the purpose of the parameter.
    ///    - const: Specifies the constant `String`-based value of a certain parameter.
...
extension _LLMToolParameterWrapper where T: AnyOptional, T.Wrapped: AnyArray,
    ...
    /// Declares an optional `Float` or `Double` (`BinaryFloatingPoint`) -based ``LLMTool/Parameter`` `array`.
    ///
    /// - Parameters:
    ///    - description: Describes the purpose of the parameter, used by the LLM to grasp the purpose of the parameter.
    ///    - const: Specifies the constant `String`-based value of a certain parameter.
...
@available(iOS 18, macOS 15, watchOS 11, *)
extension _LLMToolParameterWrapper where T: AnyOptional, T.Wrapped: AnyArray, T.Wrapped.Element == Bool {
    /// Declares an optional `Bool`-based ``LLMTool/Parameter`` `array`.
    ///
    /// - Parameters:
    ///    - description: Describes the purpose of the parameter, used by the LLM to grasp the purpose of the parameter.
    ///    - const: Specifies the constant `String`-based value of a certain parameter.
...
extension _LLMToolParameterWrapper where T: AnyOptional, T.Wrapped: AnyArray,
    ...
    /// Declares an optional `String`-based ``LLMTool/Parameter`` `array`.
    ///
    /// - Parameters:
    ///    - description: Describes the purpose of the parameter, used by the LLM to grasp the purpose of the parameter.
    ///    - pattern: A Regular Expression that the parameter needs to conform to.
