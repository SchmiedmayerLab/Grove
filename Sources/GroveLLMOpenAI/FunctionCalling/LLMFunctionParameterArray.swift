...
/// However, the usage of ``LLMFunctionParameterArrayElement`` should rarely be required as ``GroveLLMOpenAI`` automatically synthezises the OpenAI schema from `array`-based types with primitive Swift types as elements.
///
