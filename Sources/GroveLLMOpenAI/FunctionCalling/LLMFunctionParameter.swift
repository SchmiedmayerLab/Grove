...
/// However, the usage of ``LLMFunctionParameter`` should rarely be required as ``GroveLLMOpenAI`` automatically synthezises the OpenAI schema from the underlying primitive Swift types,
