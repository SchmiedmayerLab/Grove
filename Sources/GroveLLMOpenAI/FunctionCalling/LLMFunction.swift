...
///
/// The `LLMFunction` is the Grove-based implementation of an [OpenAI LLM function](https://platform.openai.com/docs/guides/function-calling).  <!-- markdown-link-check-disable-line -->
...
/// ``LLMFunction/execute()`` returns a `String?`, containing all the information the Grove application wants to provide to the LLM upon a function call,
