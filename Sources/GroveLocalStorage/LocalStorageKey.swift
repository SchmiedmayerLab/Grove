...
///     static let note = LocalStorageKey<Note>("org.example.app.note")
///     static let person = LocalStorageKey<Person>("org.example.app.person", encoder: PropertyListEncoder(), decoder: PropertyListDecoder())
/// }
/// ```
///
/// ## Topics
...
extension LocalStorageKey { // swiftlint:disable:this file_types_order
    ...
    private convenience init<E, D>(
        ...
        encoder: E,
        decoder: D
    ) where E: GroveFoundation.TopLevelEncoder & Sendable, D: GroveFoundation.TopLevelDecoder & Sendable, E.Output == Data, D.Input == Data {
    ...
    @_disfavoredOverload
    public convenience init<E: GroveFoundation.TopLevelEncoder & Sendable, D: GroveFoundation.TopLevelDecoder & Sendable>(
        _ key: String,
        setting: LocalStorageSetting = .default,
        encoder: E,
        decoder: D
...
extension GroveFoundation.TopLevelEncoder {
...
extension GroveFoundation.TopLevelDecoder {
