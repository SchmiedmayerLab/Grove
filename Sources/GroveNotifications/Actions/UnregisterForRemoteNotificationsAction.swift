...
extension EnvironmentValues {
    ...
    /// }
    /// ```
    public var unregisterRemoteNotifications: Grove.UnregisterForRemoteNotificationsAction {
        Grove.UnregisterForRemoteNotificationsAction()
    }
}


@available(iOS 18, macOS 15, watchOS 11, *)
extension Grove.UnregisterForRemoteNotificationsAction: Sendable {}
