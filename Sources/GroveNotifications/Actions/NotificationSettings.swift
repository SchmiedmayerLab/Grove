...
extension Grove {
    ...
    ///
    /// Refer to ``Grove/notificationSettings`` for documentation.
...
extension EnvironmentValues {
    ...
    /// }
    /// ```
    public var notificationSettings: Grove.NotificationSettingsAction {
        Grove.NotificationSettingsAction()
    }
}


@available(iOS 18, macOS 15, watchOS 11, *)
extension Grove.NotificationSettingsAction: Sendable {}
