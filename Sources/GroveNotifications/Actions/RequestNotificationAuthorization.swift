...
extension Grove {
    ...
    ///
    /// Refer to ``Grove/requestNotificationAuthorization`` for documentation.
...
extension EnvironmentValues {
    ...
    /// }
    /// ```
    public var requestNotificationAuthorization: Grove.RequestNotificationAuthorizationAction {
        Grove.RequestNotificationAuthorizationAction()
    }
}


@available(iOS 18, macOS 15, watchOS 11, *)
extension Grove.RequestNotificationAuthorizationAction: Sendable {}
