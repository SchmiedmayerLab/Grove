...
extension HKSample {
    ...
    ///     The `FHIRExtensionBuilder.sourceDevice`, `FHIRExtensionBuilder.sourceRevision`, and `FHIRExtensionBuilder.metadata` extension builders are always enabled when creating a FHIR `Observation`s from a `HKSample`.
