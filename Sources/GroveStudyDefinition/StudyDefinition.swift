...
///
/// ## Studies
/// The GroveStudy package models a study definition as a combination of study metadata, a list of study components, and a list of schedules for these components.
...
///
/// GroveStudy provides facilities for gracefully dealing with these kinds of changes; see <doc:StudyEvolution> for more information on this.
///
/// ## Topics
///
/// ### Initializers
