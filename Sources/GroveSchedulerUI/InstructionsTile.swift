...
/// ```
///
/// - Tip: Use the ``SwiftUICore/View/taskCategoryAppearance(for:label:image:)`` modifier to define the ``GroveScheduler/Task/Category/Appearance`` of a category.
///
...
public struct InstructionsTile<Header: View, Info: View, Footer: View>: View {
    ...
    ///   - header: A custom header that is shown on the top of the tile. You can use the [`TileHeader`](../GroveViews/GroveViews.docc/GroveViews.md)
