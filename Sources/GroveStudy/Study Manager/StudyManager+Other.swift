...
extension StudyManager {
    /// The user-facing action that is associated with a study-related `GroveScheduler.Task`
...
extension Task.Category {
    ...
    public static let informational = Self.custom("informational")
    
    /// A Timed Walking Test Task
    public static let timedWalkingTest = Self.custom("timedWalkingTest")
    /// A Timed Running Test Task
    public static let timedRunningTest = Self.custom("timedRunningTest")
    ...
    public static func customActiveTask(_ activeTask: StudyDefinition.CustomActiveTaskComponent.ActiveTask) -> Self {
        .custom("customActiveTask:\(activeTask.identifier)")
    }
}
...
@available(iOS 18, macOS 15, watchOS 11, *)
extension View {
    /// Configures the GroveStudy-specific task category appearances
...
@available(iOS 18, macOS 15, watchOS 11, *)
extension GroveScheduler.Schedule {
    /// Creates a `GroveScheduler.Schedule` from a `StudyDefinition.ComponentSchedule.ScheduleDefinition.repeated`.
    ///
