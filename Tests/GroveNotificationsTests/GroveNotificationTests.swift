...
@testable import struct Grove.Configuration
import class Grove.GroveAppDelegate
import protocol Grove.Module
...
private class TestNotificationApplicationDelegate: GroveAppDelegate {
