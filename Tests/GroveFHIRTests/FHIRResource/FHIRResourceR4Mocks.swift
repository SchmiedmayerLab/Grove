...
enum ModelsR4Mocks { // swiftlint:disable:this type_body_length
    ...
    static func createTextAttachment(
        ...
        // This is a minimal base64-encoded text with the text "Welcome to GroveFHIR"
        let textBase64 = "V2VsY29tZSB0byBHcm92ZUZISVI="
    ...
    static func createPDFAttachment(
        ...
        // This is a minimal base64-encoded PDF with the text "PDF: Welcome to GroveFHIR"
    ...
    static func createMixedDocumentReference(
        ...
        let textAttachment = try createAttachment(
            ...
            contentType: "text/plain",
            content: "V2VsY29tZSB0byBHcm92ZUZISVI="
        )
