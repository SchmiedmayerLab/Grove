...
struct FHIRAttachmentServiceTests {
    ...
    func testStringifyTextContent() throws {
        ...
        attachment.base64String = "V2VsY29tZSB0byBHcm92ZUZISVI="
        try service.stringify(attachment: &attachment)
        #expect(attachment.encodedContent == "Welcome to GroveFHIR")
    }
    ...
    func testStringifyPDFContent() throws {
        ...
        try service.stringify(attachment: &attachment)
        #expect(attachment.encodedContent == "PDF: Welcome to GroveFHIR")
    }
