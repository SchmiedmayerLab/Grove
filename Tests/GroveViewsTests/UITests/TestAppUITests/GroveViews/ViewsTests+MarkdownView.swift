...
extension ViewsTests {
    ...
    func testAdvancedMarkdownView() throws {
        ...
        assertTextExists("Welcome to the Grove Ecosystem")
        assertTextExists("This article aims to provide you with a broad overview of Grove.")
        XCTAssert(app.otherElements["ayooooooo"].waitForExistence(timeout: 2))
        assertTextExists("Our Modules")
        assertTextExists("Grove is architected to be a highly modular system, allowing your application to ...")
