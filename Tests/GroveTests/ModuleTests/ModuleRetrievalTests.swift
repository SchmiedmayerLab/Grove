...
struct ModuleRetrievalTests {
    ...
    func retrieveByExactType() {
        ...
        let grove = Grove(standard: DefaultStandard(), modules: [baseModule, derivedModule])
        
        #expect(grove.module(BaseModule.self) === baseModule)
        #expect(grove.module(DerivedModule.self) === derivedModule)
    }
    ...
    func retrieveWithTypeInference() {
        ...
        let grove = Grove(standard: DefaultStandard(), modules: [baseModule])
        
        let retrieved: BaseModule? = grove.module()
    ...
    func retrieveUnconfiguredModule() {
        ...
        let missing: BaseModule? = grove.module()
        #expect(missing == nil)
    }
    ...
    func retrieveDerivedByBaseType() {
        ...
        let grove = Grove(standard: DefaultStandard(), modules: [derivedModule])
    ...
    func derivedModuleRetainsRuntimeType() throws {
        ...
        let retrieved: BaseModule = try #require(grove.module(DerivedModule.self))
