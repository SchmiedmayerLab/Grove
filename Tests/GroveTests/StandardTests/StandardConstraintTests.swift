...
struct StandardConstraintTests {
    ...
    func unconstrainedStandardInjection() async throws {
        ...
        let grove = appDelegate.grove
        let module = try #require(grove.module(TestModule0.self))
    ...
    func constrainedStandardInjectionConstraintPresent() async throws {
        ...
        let grove = appDelegate.grove
        let module = try #require(grove.module(TestModule1.self))
...
// MARK: Supporting Grove Components
...
private final class TestAppDelegate<S: Standard>: GroveAppDelegate {
