...
/// Shows the study team's contact cards; run through `Scripts/documentation-screenshots.sh`.
final class DocumentationScreenshots: XCTestCase {
    ...
    func testCaptureDocumentationScreenshots() throws {
        ...
        XCTAssert(app.staticTexts["Study Team"].waitForExistence(timeout: 15))
        sleep(2)
        capture("ContactsList")
    }
