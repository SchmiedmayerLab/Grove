...
struct GroveSensorKitUsageSummaryTests {
    ...
    private static func messagesUsage(nativeRecording: SensorKitNativeRecording?) throws -> SensorKitMessagesUsageRecord {
        SensorKitMessagesUsageRecord(
    ...
    func invalidUsageSummariesFailClosed() throws {
        ...
        let negativeCount = SensorKitMessagesUsageRecord(
            sourceRecordID: try Self.sourceID,
            timestamp: Self.start,
            durationSeconds: 3_600,
            totalIncomingMessages: -1,
