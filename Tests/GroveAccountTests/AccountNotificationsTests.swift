...
private final class TestProvider: AccountStorageProvider {
    ...
    func store(_ accountId: String, _ modifications: GroveAccount.AccountModifications) async throws {
        Issue.record("\(#function) not implemented")
    }

    func load(_ accountId: String, _ keys: [any GroveAccount.AccountKey.Type]) async -> GroveAccount.AccountDetails? {
        Issue.record("\(#function) not implemented")
        return nil
    }
