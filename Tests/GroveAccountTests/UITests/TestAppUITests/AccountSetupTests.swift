...
final class AccountSetupTests: XCTestCase { // swiftlint:disable:this type_body_length
    ...
    func testEmbeddedViewValidation() throws {
        ...
        XCTAssertTrue(app.staticTexts["Grove Account"].waitForExistence(timeout: 5.0))
    ...
    func testLoginWithEmail() throws {
        ...
        XCTAssertTrue(app.staticTexts["Grove Account"].waitForExistence(timeout: 5))
        app.openAccountSetup()
    ...
    func testResetPassword() throws {
        ...
        XCTAssertTrue(app.staticTexts["Grove Account"].waitForExistence(timeout: 2.0))
    }
