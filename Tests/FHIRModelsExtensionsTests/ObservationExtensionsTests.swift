...
struct ObservationExtensionsTests {
    ...
    func fhirExtension() throws {
        let extension1Url: FHIRPrimitive<FHIRURI> = "https://grovealliance.org/fhir/testing/StructureDefinition/testDef1"
        let extension2Url: FHIRPrimitive<FHIRURI> = "https://grovealliance.org/fhir/testing/StructureDefinition/testDef2"
