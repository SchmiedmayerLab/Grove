...
struct MarkdownDocumentTests { // swiftlint:disable:this type_body_length
    ...
    func customElements2() throws {
        ...
        #expect(doc == MarkdownDocument(
            metadata: .init(),
            blocks: [
                .markdown(id: "grove", rawContents: "# Grove\nHello World :)"),
                .customElement(.init(
                    name: "toggle",
    ...
    func hruleParsing() throws {
        let input = """
            ---
            title: Welcome to the Grove Ecosystem
            date: 2025-06-22T14:41:16+02:00
            ---
            
            # Welcome to the Grove Ecosystem
            This article aims to provide you with a broad overview of Grove.
            
            <marquee filename="PM5544.png" period=5 />
            
            ## Our Modules
            Grove is architected to be a highly modular system, allowing your application to ...
        ...
        #expect(document == MarkdownDocument(
            ...
            blocks: [
                .markdown(
                    id: "welcome-to-the-grove-ecosystem",
                    rawContents: "# Welcome to the Grove Ecosystem\nThis article aims to provide you with a broad overview of Grove."
                ),
                .customElement(.init(
                    name: "marquee",
                ...
                .markdown(id: "grovehealthkit", rawContents: "### GroveHealthKit\ntext text text")
            ]
        ))
    }
